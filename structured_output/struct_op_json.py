...
review_schema = {
  ...
  "properties": {
    ...
    "pros": {
      "type": ["array", "null"],  #optional field --> list or None(or Null)
      "items": {
        "type": "string"
      },
...
Review by Garv Tyagi
"""
)
print(result)
print(type(result))  #list of object  --> {'key':'value'} --> obj.key

# List of objects
reviewer_name = result[0]['args']['name']
print(reviewer_name)